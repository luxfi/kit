...
> {
  ...
  openModal: LuxKitModal["open"];
  closeModal: LuxKitModal["close"];
  setTheme: LuxKitModal["setTheme"];

  setDisclaimer: LuxKitModal["setDisclaimer"];
  setCustomButtons: LuxKitModal["setCustomButtons"];
}
...
export const luxkitConnect = (prams: ConnectParameters) => {
  const wagmiConfig = useRKStore.getState().wagmi;
